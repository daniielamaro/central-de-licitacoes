...
@Component({
   selector: 'app-alterar-parecer-diretor',
   template: '',
})
export class AlterarParecerDiretorComponent implements OnInit {
   constructor(
            ...
            return this.alterarservice
               ...
               .then((response) => {
                  return response.json().then((e) => {
                     ...
                     return this.alterarservice
                        .verificarParecerDiretor(id)
                        .then((response) => {
                           return response.json().then((p) => {
                              if (!p) {
                                 throw new Error(
                                    'Não encontrei o parecer para o edital com o ID: ' + id
                                 );
                              }
